...
import ecommerce1 from "../Media/showoff/poki6.png";
import ecommerce2 from "../Media/showoff/poki3.png";
import ecommerce3 from "../Media/showoff/poki4.png";
import ecommerce4 from "../Media/showoff/pokemon6.png";
...
const projects = [
  ...
  
  {
    ...
    subtitle: "echoes",
    description:
      "Built and deployed a production-quality blog application using Appwrite (backend-as-a-service). Utilizing a modern tech stack, including React.js, Tailwind CSS, and various other libraries, I engineered the application for seamless performance and robust functionality.",
...
function Project() {
  const [mainImageIndices, setMainImageIndices] = useState(
  ...
  return (
    <section className="h-full px-2 bg-radial-gradient md:px-4 lg:px-10 py-10 dark:bg-gradient-to-r dark:from-black dark:via-gray-950 dark:to-gray-900 dark:text-white text-black">
      <h1 className="dark:drop-shadow-[0_0_5px_rgba(0,0,225,1)] px-2 sm:pl-5 md:px-12 text-2xl md:text-3xl lg:text-5xl mb-7 font-bold text-blue-600 dark:text-blue-400">
        # Projects
      </h1>
          ...
          <div key={projectIndex}>
            <div className="flex mx-2 md:mx-4 lg:mx-12 my-3 gap-3">
              ...
              <motion.div
                ...
                className="h-auto  flex flex-col items-center -mt-1 gap-2 lg:gap-3 flex-[0.32]"
              >
                {project.images.map(
                  (image, subImageIndex) =>
                    subImageIndex !== mainImageIndex && (
                      <div key={subImageIndex}>
                        <img
                          ...
                          src={image}
                          onClick={() =>
                            handleImageClick(projectIndex, subImageIndex)
                          }
                          alt={project.title}
                        />
                      </div>
            ...
            <div className="px-4 lg:px-12">
              <div className="flex gap-3 lg:gap-5 mx-2 lg:mx-6 mt-5 mb-5">
                ...
                >
                  <a
                    href={project.github}
                    target="_blank"
                    className="border-2 border-blue-700 dark:border-blue-500 px-2 py-1 lg:px-4 lg:py-2 text-lg rounded hover:bg-blue-600 dark:hover:bg-blue-600 duration-150"
                  >
                    Github
                  </a>
                </motion.button>
              ...
              <div className="tracking-wider text-xl">
                ...
                <motion.span
                  ...
                  whileInView="visible"
                  variants={variants}
                  transition={{ transition: 1, delay: 0.7 }}
                ...
                <motion.span
                  ...
                  whileInView="visible"
                  variants={variants}
                  transition={{ transition: 1, delay: 0.9 }}
                  className="inline-block mt-3 pb-3"
                >
                  {project.description}
                </motion.span>
              </div>
